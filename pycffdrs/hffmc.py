...
def hffmc(weatherstream, ffmc_old=85, time_step=1,
    ...
    #############################################################################
    t0 = time_step
    # TODO: what does this translate to?
    # NOTE: Assuming weatherstream is a numpy array, we can simply change the field names
    # as follows:
    # weatherstream.dtype.names = ('temp', 'rh', 'ws', 'precip', 'hourly', 'bui')
    # SO: we'll just iterate though the existing name, and lowercase them.
